...
export function useProjects(): PortfolioProject[] {
  return [
    ...
    },
    {
      key: 'trelltech',
      name: 'TrellTech',
      url: 'https://trelltech.antoinegourgue.dev',
      domain: 'trelltech.antoinegourgue.dev',
      repoHint: 'trelltech',
      image: '/assets/projects/trelltech.jpg',
      icon: '/assets/projects/trelltech-icon.png',
      letter: 'T',
      colorTop: '#6D6DF0',
      colorBottom: '#4F46D6',
      categoryKey: 'macos.catProductivity',
      year: '2026',
      stack: 'Next.js 15 · Fastify · Prisma · WebSocket',
    },
    {
      key: 'epihardware',
      name: 'EpiHardware',
